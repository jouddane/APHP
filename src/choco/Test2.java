...
public class Test2 {
	...
	public static void main(String[] args) {
			...
			Soin ECG15 = Soin.creerSoin(donnees, listRessourceCapacite2, "ECG15", 3);
			...
			Soin BilanBiologique15 = Soin.creerSoin(donnees, listRessourceCapacite3, "Bilan Biologique15", 3);

			ArrayList<CoupleStringInt> listRessourceCapacite4 = new ArrayList<>();	 
			listRessourceCapacite4.add(new CoupleStringInt("Hors HDJ",1));	 	 	
			Soin EchoHepathique = Soin.creerSoin(donnees, listRessourceCapacite4, "Echo Hepathique", 3);
			...
			Soin Calorimetrie = Soin.creerSoin(donnees, listRessourceCapacite5, "Calorimetrie", 6);
			...
			Soin EntretienPsy = Soin.creerSoin(donnees, listRessourceCapacite6, "Entretien Psy", 8);
			...
			Soin EntretienInfirmier = Soin.creerSoin(donnees, listRessourceCapacite7, "Entretien Infirmier", 6);
			...
			Soin EntretienDiet60 = Soin.creerSoin(donnees, listRessourceCapacite8, "Entretien Diet60", 12);
			...
			Soin SyntheseNutriHDJOb = Soin.creerSoin(donnees, listRessourceCapacite9, "SyntheseNutriHDJOb", 6);
			...
			Soin RDVParamedical20 = Soin.creerSoin(donnees, listRessourceCapacite10, "RDV Paramedical20", 4);
			...
			Soin TOGD = Soin.creerSoin(donnees, listRessourceCapacite11, "TOGD", 4);
			...
			Soin BilanAnthropometrique = Soin.creerSoin(donnees, listRessourceCapacite13, "Bilan Anthropometrique", 12);
			...
			Soin Fibroscan = Soin.creerSoin(donnees, listRessourceCapacite14, "Fibroscan", 2);
			...
			Soin RDVParamedical15 = Soin.creerSoin(donnees, listRessourceCapacite15, "RDV Paramedical15", 3);
			...
			Soin ScannerAbdo = Soin.creerSoin(donnees, listRessourceCapacite16, "Scanner Abdo", 4);
			...
			Soin EntretienHepato = Soin.creerSoin(donnees, listRessourceCapacite17, "Entretien Hepato", 9);
			...
			Soin TraitementRemicade = Soin.creerSoin(donnees, listRessourceCapacite18, "Traitement Remicade", 24);
			...
			Soin SyntheseNutriCS = Soin.creerSoin(donnees, listRessourceCapacite19, "SyntheseNutriCS", 6);
			...
			Soin PonctionAscite = Soin.creerSoin(donnees, listRessourceCapacite20, "Ponction Ascite", 36);
			...
			Soin SoinsPonction2h15 = Soin.creerSoin(donnees, listRessourceCapacite21, "Soins Ponction2h15", 27);
			...
			Soin InjectionFerinject = Soin.creerSoin(donnees, listRessourceCapacite22, "Injection Ferinject", 12);
			...
			Soin Prelevement25 = Soin.creerSoin(donnees, listRessourceCapacite23, "Prelevement25", 5);
			...
			Soin PoseHolter = Soin.creerSoin(donnees, listRessourceCapacite24, "Pose Holter", 3);
			...
			Soin Retinographie = Soin.creerSoin(donnees, listRessourceCapacite25, "Retinographie", 3);
			...
			Soin EchodopplerTSAetMI = Soin.creerSoin(donnees, listRessourceCapacite26, "Echodoppler TSA et MI", 6);
			...
			Soin ScannerDesCorronaires = Soin.creerSoin(donnees, listRessourceCapacite27, "Scanner Des Corronaires", 2);
			...
			Soin ScintigraphieMyocardique = Soin.creerSoin(donnees, listRessourceCapacite28, "Scintigraphie Myocardique", 6);
			...
			Soin Injection = Soin.creerSoin(donnees, listRessourceCapacite29, "Injection", 8);
			...
			Soin RDVMedical40 = Soin.creerSoin(donnees, listRessourceCapacite30, "RDV Medical40", 8);
			...
			Soin EntretienDiet30 = Soin.creerSoin(donnees, listRessourceCapacite31, "Entretien Diet30", 6);
			...
			Soin RDVMedical35 = Soin.creerSoin(donnees, listRessourceCapacite32, "RDV Medical35", 7);
			...
			Soin Prelevement15 = Soin.creerSoin(donnees, listRessourceCapacite33, "Prelevement15", 3);
			...
			Soin ScannerTMDPiedRadios = Soin.creerSoin(donnees, listRessourceCapacite34, "Scanner TMD Pied + Radios", 8);
			...
			Soin DopplerDesArteresDesMI = Soin.creerSoin(donnees, listRessourceCapacite35, "Doppler Des Arteres Des MI", 6);
			...
			Soin SoinPansementMesuresIPS = Soin.creerSoin(donnees, listRessourceCapacite36, "Soin, Pansement, Mesures IPS", 8);
			//System.out.println("done");
			...
			Soin PosePompeEtOuHolter = Soin.creerSoin(donnees, listRessourceCapacite37, "Pose Pompe Et/Ou Holter", 6);
			...
			Soin RDVMedical20BurCS = Soin.creerSoin(donnees, listRessourceCapacite38, "RDV Medical20BurCS", 4);
			...
			Soin ConsultationPsy20 = Soin.creerSoin(donnees, listRessourceCapacite39, "Consultation Psy20", 4);
			...
			Soin Examens30 = Soin.creerSoin(donnees, listRessourceCapacite40, "Examens30", 6);
			//System.out.println("done");
			...
			Soin Appareillage60 = Soin.creerSoin(donnees, listRessourceCapacite41, "Appareillage60", 12);
			//System.out.println("done");
			...
			Soin RDVMedical20BurSom = Soin.creerSoin(donnees, listRessourceCapacite42, "RDV Medical20BurSom", 4);
			...
			Soin ETPSom = Soin.creerSoin(donnees, listRessourceCapacite43, "ETPSom", 18);
			...
			Soin Appareillage45 = Soin.creerSoin(donnees, listRessourceCapacite44, "Appareillage45", 9);
			...
			Soin BilanBiologique20 = Soin.creerSoin(donnees, listRessourceCapacite45, "Bilan Biologique20", 4);
			...
			Soin ECG10 = Soin.creerSoin(donnees, listRessourceCapacite46, "ECG10", 2);

			ArrayList<CoupleStringInt> listRessourceCapacite47 = new ArrayList<>();	 	 	 
			Soin TestDEfforts = Soin.creerSoin(donnees, listRessourceCapacite47, "Test D'Efforts", 5);
			...
			Soin Consultations = Soin.creerSoin(donnees, listRessourceCapacite48, "Consultations", 6);
			...
			Soin ExplorationsFonctionnellesOuMorphologiques = Soin.creerSoin(donnees, listRessourceCapacite49, "Explorations Fonctionnelles Ou Morphologiques", 8);
			...
			Soin Bilan = Soin.creerSoin(donnees, listRessourceCapacite50, "Bilan", 6);
			...
			Soin TestFonctionnel = Soin.creerSoin(donnees, listRessourceCapacite51, "Test Fonctionnel", 4);
			...
			Soin IRM40 = Soin.creerSoin(donnees, listRessourceCapacite52, "IRM40", 8);
			...
			Soin EchoCardiaque = Soin.creerSoin(donnees, listRessourceCapacite53, "Echo Cardiaque", 4);
			...
			Soin ExamenClinique30 = Soin.creerSoin(donnees, listRessourceCapacite54, "Examen Clinique30", 6);
			...
			Soin ETPCard = Soin.creerSoin(donnees, listRessourceCapacite55, "ETPCard", 6);
			...
			Soin MedecineNucleaire = Soin.creerSoin(donnees, listRessourceCapacite56, "Medecine Nucleaire", 6);
			...
			Soin RDVAccueil = Soin.creerSoin(donnees, listRessourceCapacite57, "RDV Accueil", 1);
			...
			Soin Prelevement20 = Soin.creerSoin(donnees, listRessourceCapacite58, "Prelevement20", 4);
			...
			Soin IRM45 = Soin.creerSoin(donnees, listRessourceCapacite59, "IRM45", 9);
			...
			Soin ARM = Soin.creerSoin(donnees, listRessourceCapacite60, "ARM", 3);
			...
			Soin EchodopplerTSA = Soin.creerSoin(donnees, listRessourceCapacite61, "Echodoppler TSA", 4);
			...
			Soin ETT = Soin.creerSoin(donnees, listRessourceCapacite62, "ETT", 4);
			...
			Soin Holter = Soin.creerSoin(donnees, listRessourceCapacite63, "Holter", 6);
			...
			Soin BilanCardiaque = Soin.creerSoin(donnees, listRessourceCapacite64, "Bilan Cardiaque", 4);
			...
			Soin SyntheseNeuro = Soin.creerSoin(donnees, listRessourceCapacite65, "SyntheseNeuro", 6);
			...
			Soin ExamenClinique15 = Soin.creerSoin(donnees, listRessourceCapacite66, "Examen Clinique15", 3);
			...
			Soin EEG = Soin.creerSoin(donnees, listRessourceCapacite67, "EEG", 8);
			...
			Soin ScintigraphieCerebrale = Soin.creerSoin(donnees, listRessourceCapacite68, "Scintigraphie Cérébrale", 8);
			...
			Soin PonctionLombaire = Soin.creerSoin(donnees, listRessourceCapacite69, "Ponction Lombaire", 3);
			...
			Soin SoinsPonction3h = Soin.creerSoin(donnees, listRessourceCapacite70, "Soins Ponction3h", 36);
			...
			Soin ConsultationNeuropsy = Soin.creerSoin(donnees, listRessourceCapacite71, "Consultation Neuropsy", 36);
			...
			Soin ConsultationPsy30 = Soin.creerSoin(donnees, listRessourceCapacite72, "Consultation Psy30", 6);	 	 
			...
			listRessourceCapacite72.add(new CoupleStringInt("Bureau CS", 1));	 	 
			Soin RDVMedicalDiet = Soin.creerSoin(donnees, listRessourceCapacite73, "RDV Medical Diet", 6);	 	 
