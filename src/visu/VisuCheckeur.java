...
public class VisuCheckeur extends ApplicationFrame{
	...
	/**
	 * Construit le graph pour visualiser si la contrainte de ressource est respect�e
	 *
	...
	/**
	 * Cr�e les donn�es n�cessaires pour la ressource a.
	 *
	 * @return Series 1.
	 */
	private XYDataset createDataset1(int a) {
		...
		final TimeSeries s1 = new TimeSeries("Capacit� "+a, Minute.class);



		//Cr�ation du tableau ou on stocke toutes les ressources utilisees au cours de la journee
		...
		for(int i=0;i<this.aResoudre.getnPatients();i++){
			...
			final TimeSeries s2 = new TimeSeries("Capacit� max RM "+a, Minute.class);
